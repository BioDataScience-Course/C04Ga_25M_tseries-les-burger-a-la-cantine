...
Tout d'abord, la série montre qu'en début 2020, la fréquentation était très faible. Après les 6 premiers mois, la fréquentation revient à la normale avant de chuter à nouveau. Après la 2e moitié de 2021, la fréquentation est revue à la hausse, dépassant même la fréquentation initiale.
...
avant <- window(residential_ts1, start = c(2020, 78), end = c(2021, 160))
...
après <- window(residential_ts1, start = c(2021, 160), end = c(2022, 288))
...
La pandémie a eu différents impacts selon les différents types de lieux fréquentés. 
Pour les magasins de détail et de loisir, la fréquentation a dépassé les seuils d'avant la pandémie dès mi-2021, suggérant que les consommateurs ont eu une phase de rattrapage, vu qu'ils n'ont pas pu profiter de ce genre de services durant les confinements.
à titre de comparaison, la fréquentation des lieux de travail n'est jamais revenue à la normale. Cela témoigne d'une transformation dans le monde professionnel.
Les résidences ont été nettement plus fréquentées dû au confinement, ce qui est assez logique. Post-confinement, la fréquentation est restée supérieure à la normale, ce qui se corrèle bien avec la fréquentation des lieux de travail.
Le 2e confinement a eu un impact nettement moins sévère que le premier.
