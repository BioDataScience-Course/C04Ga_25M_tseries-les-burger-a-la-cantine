...
plot(retail_recreation_ts2, ylab = "Pourcentage de déplacement vers les magasins de détail et loisirs", xlab = "Temps")
...
plot(conf_aggregate, xlab = "Temps", ylab = "Variation dans les déplacements vers les magasins de détails et de loisir (%)", main = "Période de confinement: Jours de la semaine agrégés")
...
plot(after_aggregate, xlab = "Temps", ylab = "Variation dans les déplacements vers les magasins de détails et de loisir (%)", main = "Période post confinement: Jours de la semaine agrégés")
abline(h = 0, col = "red", lty = 2)
...
plot(conf_rr_local, main = "Tendances locales - Période de confinement")
