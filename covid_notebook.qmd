...
r_ts <-ts(mobw$residential, start = c(2020, 46), frequency = 365)
residential_ts2 <- aggregate(r_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
...
residential_ts3 <- window(r_ts, start = c(2020, 46), end = c(2021, 160))
avant <- aggregate(residential_ts3, 52, FUN = collapse::fmean, ts.eps = 1/52)
...
residential_ts3 <- window(r_ts, start = c(2021, 161), end = c(2022, 288))
après <- aggregate(residential_ts3, 52, FUN = collapse::fmean, ts.eps = 1/52)
...
conf1_r <- window(r_ts, start = c(2020, 78), end = c(2020, 167))
data.between_r <- window(r_ts, start = c(2020, 167), end = c(2020, 307))
conf2_r <- window(r_ts, start = c(2020, 307), end = c(2021, 160))
