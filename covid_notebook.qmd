...
mobw_ts <- ts(mobw$parks, start = c(2020, 46), frequency = 365)
plot(mobw_ts)
# Aggrégation par moyenne des valeurs par semaine
mobw_ts2 <- aggregate(mobw_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
plot(mobw_ts2)

#code que j'ai fait - Anaïs
covid_ts <- ts(covid, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
class(covid_ts)
plot(covid_ts)

retail_recreation_ts <- ts(covid$retail_recreation, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(retail_recreation_ts)
grocery_pharmacy_ts <- ts(covid$grocery_pharmacy, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(grocery_pharmacy_ts)
parks_ts <- ts(covid$parks, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(parks_ts)
transit_ts <- ts(covid$transit, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(transit_ts)
workplaces_ts <- ts(covid$workplaces, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(workplaces_ts)
residential_ts <- ts(covid$residential, start = c(2020, 2, 15), end = c(2022, 10, 15), frequency = 365)
plot(residential_ts)
```
...
# Lucie
# retail_recreation_ts en fonction des semaines
stat.slide(time(retail_recreation_ts), retail_recreation_ts, xmin = 2020, deltat = 1/52)->r_r_ts 
plot(r_r_ts)
# grocery_pharmacy_ts en fonction des semaines
stat.slide(time(grocery_pharmacy_ts), grocery_pharmacy_ts, xmin = 2020, deltat = 1/52)->g_p_ts
plot(g_p_ts)
# parks_ts en fonction des semaines 
stat.slide(time(parks_ts), parks_ts, xmin = 2020, deltat = 1/52)->p_ts
plot(p_ts)
# transit_ts en fonction des semaines
stat.slide(time(transit_ts), transit_ts, xmin = 2020, deltat = 1/52)->t_ts
plot(t_ts)
# workplaces_ts en fonction des semaines
stat.slide(time(workplaces_ts), workplaces_ts, xmin = 2020, deltat = 1/52)->w_ts
plot(w_ts)
# residential_ts en fonction des semaines
stat.slide(time(residential_ts), residential_ts, xmin = 2020, deltat = 1/52)->r_ts
plot(r_ts)
```
