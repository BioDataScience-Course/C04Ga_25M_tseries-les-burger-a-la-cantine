...
conf_rr <- window(retail_recreation_ts, start = c(2020, 78), end = c(2021, 160))

# Décomposition de la série: période après les 2 confinements (du 9 juin 2021 à la fin de 2022)

after_rr <- window(retail_recreation_ts, start = c(2021, 160), end = c(2022, 288))
...
conf1_rr <- window(retail_recreation_ts, start = c(2020, 78), end = c(2020, 167))
data.after_rr <- window(retail_recreation_ts, start = c(2020, 167), end = c(2020, 307))
conf2_rr <- window(retail_recreation_ts, start = c(2020, 307), end = c(2021, 160))
