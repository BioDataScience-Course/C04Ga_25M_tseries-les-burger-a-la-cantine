...
# Décomposition: période de confinement 1, période entre les deux confinements, et la deuxième période de confinement
conf1_r <- window(residential_ts2, start = c(2020, 77), end = c(2020, 167))
...
data.between_r <- window(residential_ts2, start = c(2020, 167), end = c(2020, 306))
...
conf2_r <- window(residential_ts2, start = c(2020, 306), end = c(2021, 160))
