...
plot(residential_ts,  ylab = "Pourcentage de déplacement vers les lieux de résidences", main = "Mobilité vers les lieux de résidences jour par jour")

# Aggrégation par moyenne des valeurs par semaine
# Série avec une "moyenne sur la semaine"
residential_ts1 <- aggregate(residential_ts, 52, FUN = collapse::fmean, ts.eps = 1/52)
plot(residential_ts1, ylab = "Pourcentage de déplacement vers les lieux de résidences", main = "Mobilité vers les lieux de résidences semaine par semaine")
...
plot(residential_ts2, ylab = "Pourcentage de déplacement vers les lieux de résidences", main = "Mobilité vers les lieux de résidences semaine par semaine en omettant les weekends")
...
plot(residential_ts3, ylab = "Pourcentage de déplacement vers les lieux de résidences", main = "Mobilité vers les lieux de résidences weekends par weekends")
```
