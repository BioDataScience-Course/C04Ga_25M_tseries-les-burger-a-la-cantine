...
Tout d'abord, la partie contenant les deux confinements :
- Les différents graphiques permettent de voir que la population belge est restée plus souvent à la maison. 
- L'autocorrélation est non-significative car la plupart des pics ne se situent pas en dehors de l'intervalle de confiance. 
- La tendance est positive selon les tests de tendance. 

Ensuite, pour la période post-confinements :
- Les graphiques présentent des oscillations montrant le retour des déplacements (par exemple, le travail) mais le télétravail étant devenu plus fréquents, on reste tout de même plus à la maison. 
- Le test afc a la majorité des pics situés à l'intérieur de l'enveloppe de confiance donc l'autocorrélation n'est pas significative. 
- Les tests de tendance montrent une forte variabilité ce qui pourrait s'expliquer par le travail en hybride. 
