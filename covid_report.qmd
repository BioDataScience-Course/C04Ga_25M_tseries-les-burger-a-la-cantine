...
Cette étude s'appuie sur des données de mobilité communautaire fournies par Google, couvrant la période 2020-2022 de la pandémie de COVID-19 dans 135 pays. Ces données anonymisées et agrégées, issues notamment de Google Maps, ont constitué un outil précieux pour les autorités de santé publique dans leur prise de décision.
